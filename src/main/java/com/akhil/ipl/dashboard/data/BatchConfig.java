...
//            "eliminator", "method", "umpire1", "umpire2" };
	...
	private final String[] FIELD_NAMES = new String[] { "id", "city", "date", "season", "match_number", "team1",
			"team2", "venue", "toss_winner", "toss_decision", "super_over", "winner", "result", "result_margin",
			"method", "player_of_match", "team1_players", "team2_players", "umpire1", "umpire2" };
	@Autowired
	...
	public Step step1(JdbcBatchItemWriter<Match> writer) {
		return stepBuilderFactory.get("step1").<MatchData, Match>chunk(10).reader(reader()).processor(processor())
				.writer(writer).build();
	}
}